...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'django_template.apis.renderers.DefaultRenderer',
    ),
...
#         "LOCATION": "redis://{}".format(REDIS_HOST),
#         "OPTIONS": {
...
#             "MASTER_CACHE": f"redis://{REDIS_HOST}",
#             "DB": 4,
#         },
...
# CELERY_TASK_DEFAULT_QUEUE = 'django_template.celery'
#
